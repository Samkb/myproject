...
{
	$id=$_GET['delete_id'];
	$res=$con->deleteHoliday($id);
	if($res)
	{
		?>
		<script>alert('Record Deleted ...')window.location='dashboard1.php?action=holidays_list'</script>
		<?php
	}
	else
	{
		?>
		<script>alert('Record cant Deleted !!!')window.location='dashboard1.php?action=holidays_list'</script>
		<?php
	}
}
...
<section class="wrapper">
	...
	<div class="row">
		<div class="col-md-12">
			<a href="dashboard1.php?action=add_holidays" type="button" class="btn btn-success btn-flat margin" style="margin-top: 32px;">Add Holidays</a>
			<div class="box box-success">
				<div class="box-header">
					<h3 class="box-title">Holidays List</h3>
					<div class="box-tools">
						<form method="GET" action="dashboard1.php?action=add_holidays" accept-charset="UTF-8">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover">
						...
						<?php
						$sql=$con->selectHoliday();
						while($row=mysql_fetch_array($sql))
						{
							?>
							<tr>
								<td><?php echo $row['id'];?></td>
								<td><a href="#"><?php echo $row['holiday_name'];?></a></td>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														<a href="javascript:void(0);" onclick="if( confirm('Are you sure want to delete'))window.location='dashboard1.php?action=holidays_list&delete_id=<?php echo $row['id']; ?>"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															...
															<div class="modal-footer">
																<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal">Close</button>
																<a href="javascript:void(0);"  onclick="window.location='dashboard1.php?action=holidays_list&delete_id=<?php echo $row['id']; ?>';">
																	<input class="btn btn-success btn-flat" type="submit" value="Yes">
																</a>
															</div>
														</div>
